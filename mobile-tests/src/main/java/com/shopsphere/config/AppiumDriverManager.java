...
public class AppiumDriverManager {
    ...
    private static AndroidDriver createAndroidDriver() throws MalformedURLException {
        ...
        String defaultApkPath = System.getProperty("user.home")
                + "/Downloads/shopsphere-qa-suite/mobile-tests/src/test/resources/apps/SauceLabs.apk";
        caps.setCapability("platformVersion", System.getProperty("platform.version", "16"));
        caps.setCapability("automationName",  "UIAutomator2");
        caps.setCapability("app",             System.getProperty("app.path", defaultApkPath));
        ...
        return new AndroidDriver(new URL(APPIUM_SERVER), caps);
    }
    private static IOSDriver createIOSDriver() throws MalformedURLException {
        ...
        caps.setCapability("newCommandTimeout", 300);
        return new IOSDriver(new URL(APPIUM_SERVER), caps);
    }
