...
public class CheckoutPage extends BasePage {
    ...
    public CheckoutPage fillCheckoutInfo(String firstName, String lastName, String postalCode) {
        // Use BasePage.type() — identical to how LoginPage fills its fields.
        // type() calls element.clear() + element.sendKeys() via the WebDriver
        // protocol directly, which works in all environments including headless
        // Chrome in a container with no display server.
        // Actions.sendKeys() was tried previously but requires a display server
        // and silently does nothing in a containerised Jenkins environment.
